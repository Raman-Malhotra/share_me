...
const CreatePin = ({user}) => {
  ...
  const uploadImage=(e)=>{
    ...
    if(selectedFile.type==='image/png'||selectedFile.type==='image/svg'||selectedFile.type==='image/svg'||selectedFile.type==='image/jpeg'||selectedFile.type==='image/gif'||selectedFile.type==='image/tiff')
    {
  ...
  return <div className="flex flex-col justify-center items-center mt-5 lg:h-4/4" >
    {fields&&(
        ...
        <div className="flex flex-col">
          <div>
            ...
            {categories.map((category)=>(
              <option className="text-base border-0 outline-none capitalize bg-white text-black" value={categories.name}>
                {category.name}
              </option>
            ))}
